# Estabilizacion operativa en rama pre comercial

## 1. Objetivo

Reaplicar los fixes funcionales de estabilizacion sobre feat/correcciones-pre-etapa-comercial, preservando la estructura visual mas reciente de esa rama.

El objetivo operativo es sincronizar la experiencia entre Clientes, Servicios contratados, Ordenes de Trabajo, Prospectos, Planes, Cobranza e Inventario antes de incorporar nuevas funcionalidades comerciales.
...
Nota de portabilidad: esta rama no contiene commercial-control. Por lo tanto, no se portaron CommercialControlModule, CommercialControlPanel ni pruebas asociadas.
...
No se modifico BillingPanel. El Libro Control Comercial no existe en esta rama y queda fuera del port selectivo.
...
## 6. Recomendacion antes de continuar etapa comercial

Avanzar con nuevas funcionalidades comerciales solo despues de validar manualmente Clientes, Servicios, Ordenes de Trabajo y Cobranza con datos demo. La prioridad inmediata debe ser asegurar que pagos, suspensiones y cierres tecnicos de OT se reflejen de forma consistente en la gestion de cliente/servicio.
